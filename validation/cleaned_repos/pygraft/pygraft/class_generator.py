...
class ClassGenerator:
    ...
    def assemble_class_info(self):
        ...
        class_info = {
            ...
            "class2disjoints_extended": {
                c: list(set(classes))
                for c, classes in self.disjointwith_extended.items()
            },
    ...
    def create_deep_leaf_deterministic(self, c):
        ...
        layer = (
            max(
                (key for key, value in self.layer2classes.items() if value),
                default=None,
            )
            - 1
        )
        ...
        while current_class_disjointness < self.avg_disjointness:
            ...
            while not found:
                ...
                while (
                    B == A
                    or (
                        A in self.class2superclasses_transitive
                        and B in self.class2superclasses_transitive[A]
                    )
                    or (
                        A in self.class2subclasses_transitive
    ...
    def print_schema(self):
        ...
        table = [
            ...
            [
                ...
                round(
                    calculate_class_disjointness(self.disjointwith, len(self.classes)),
                    2,
                ),
