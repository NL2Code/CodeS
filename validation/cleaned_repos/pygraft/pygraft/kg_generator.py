...
class InstanceGenerator:
    ...
    def assemble_instance_info(self):
        ...
        typed_observed = {
            ...
            if entity in self.ent2classes_specific
        }
    ...
    def assign_most_specific(self):
        ...
        generated_numbers = np.clip(
            np.floor(scaled_numbers), 1, hierarchy_depth
        ).astype(int)
        generated_numbers = [
        ...
        self.ent2layer_specific = {
            e: l for e, l in zip(self.is_typed, generated_numbers)
        }
    ...
    def extend_superclasses(self):
        ...
        for ent, specific_cls in self.ent2classes_specific.items():
            ...
            self.ent2classes_transitive[ent] = list(
                set(self.ent2classes_transitive[ent])
            )
    ...
    def find_compatible_classes(self, class_list):
        ...
        return set(compatible_classes) - set(class_list) | set(
            self.non_disjoint_classes
        )
        ...
        if self.fast_gen:
            ...
            for _ in range(1, self.fast_ratio):
                ...
                ent2classes_specific = {
                    e: ent2classes_spec_values[idx]
                    for idx, e in enumerate(typed_entities)
                }
                ent2classes_transitive = {
                    e: ent2classes_trans_values[idx]
                    for idx, e in enumerate(typed_entities)
                }
    ...
    def generate_triples(self):
        ...
        self.flattened_unseen = list(
            set((itertools.chain(*self.class2entities.values())))
        )
    ...
    def procedure_2(self):
        ...
        for r1 in rel2inverse:
            ...
            if (
                r2 in self.rel2range
                and self.rel2range[r2] in self.class2disjoints_extended
            ):
