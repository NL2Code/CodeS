...
class Settings(BaseSettings):
    ...
    BASE_PROCESSED_FOLDER: str = (
        "processed"  # After a chunk is processed, an empty file is created here
    )
    ...
    CONVERSION_WORKERS: int = (
        18  # Number of workers to use to convert pdfs for each libgen chunk
    )
    ...
    MARKER_MIN_LENGTH: int = (
        10000  # Min amount of text to extract from file naively before using marker
    )
