...
class FrameStatThis(Widget):
    ...
    def compose(self):
        ...
        yield Static(self.frame_this_total_value_humanize, id="stat-this-total-value")
...
class FrameStatAll(Widget):
    ...
    def compose(self):
        ...
        yield Static(self.frame_all_total_value_humanize, id="stat-all-total-value")
        yield Static(self.frame_all_self_value_humanize, id="stat-all-self-value")
...
class FrameDetail(Widget):
    ...
    def compose(self):
        ...
        span_stack_container = VerticalScroll(span_detail, id="span-stack-container")
