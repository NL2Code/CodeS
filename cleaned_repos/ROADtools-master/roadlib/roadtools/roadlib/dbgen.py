...
def gen_link_fkey(
    ...
    return link_tpl_fkey.format(
        rel_name, ref_table, link_name, ref_column, sec_ref_column, rev_rel_name
    )
...
tables = [
    ...
    (
        ...
        ["group_member_group", "role_member_group", "au_member_group"],
    ),
