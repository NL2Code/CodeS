...
class Ui_MainWindow2(object):
    def setupUi(self, MainWindow, hselected=None):
        ...
        self.host_terminal.setObjectName("label_3")
        ...
        self.frame_div_content_2.setStyleSheet(
            "background-color: rgb(41, 45, 56);\n" "border-radius: 5px;\n" ""
        )
        ...
        self.system_terminal.setObjectName("label_2")
        ...
        icon3 = QIcon()
        icon3.addFile(
            ":/24x24/icons/24x24/cil-reload.png", QSize(), QIcon.Normal, QIcon.Off
        )
        ...
        icon4 = QIcon()
        icon4.addFile(
            ":/24x24/icons/24x24/cil-lock-locked.png", QSize(), QIcon.Normal, QIcon.Off
        )
        ...
        icon5 = QIcon()
        icon5.addFile(
            ":/24x24/icons/24x24/cil-lock-unlocked.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        icon7 = QIcon()
        icon7.addFile(
            ":/24x24/icons/24x24/cil-camera.png", QSize(), QIcon.Normal, QIcon.Off
        )
        ...
        icon8 = QIcon()
        icon8.addFile(
            ":/24x24/icons/24x24/cil-video.png", QSize(), QIcon.Normal, QIcon.Off
        )
        ...
        self.gridLayoutPixMap.setObjectName("gridLayoutPixMap")
    ...
    def save_screenshot(self):
        ...
        try:
            if os.path.isfile(f"bin/resources/cache/screenshot_{self.hselected}.png"):
                with open(
                    f"bin/resources/cache/screenshot_{self.hselected}.png", "rb"
                ) as read_img:
    ...
    def katana_shell(self):
        ...
        if (
            self.lineEdit_2.displayText() == "-clear"
            or self.lineEdit_2.displayText() == "clear"
        ):
            ...
            with open("bin/profile/vstream_size.txt", "w") as f:
                f.write(
                    self.lineEdit_2.text().replace("-svideosize ", "").rstrip().lstrip()
                )
            self.lineEdit_2.clear()
            return
            ...
            fsize = (
                str(self.lineEdit_2.displayText())
                .replace("-fontsize", "")
                .replace(" ", "")
            )
            self.lineEdit_2.clear()
            ...
            if gcts == self.host_terminal.text():
                self.host_terminal.setText(f"Looking for opened ports, Please wait.\n")
            else:
                self.host_terminal.setText(f"Looking for opened ports, Please wait.\n")
            self.lineEdit_2.clear()
            ...
            gcts = self.host_terminal.text()
            if gcts == "" or gcts == " ":
                self.host_terminal.setText(f"Keylogger function will be started.\n")
            else:
                self.host_terminal.setText(
            ...
            gcts = self.host_terminal.text()
            if gcts == "" or gcts == " ":
                self.host_terminal.setText(f"Keylogger function will be stopped.\n")
            else:
                self.host_terminal.setText(
            ...
            gcts = self.host_terminal.text()
            if gcts == "" or gcts == " ":
                self.host_terminal.setText(f"Trying to open the keylogger log.\n")
            else:
                self.host_terminal.setText(
    ...
    def call_sc(
        ...
        if (
            self.lineEdit.displayText() == "-clear"
            or self.lineEdit.displayText() == "clear"
        ):
            self.lineEdit.clear()
        ...
        if (
            self.lineEdit.displayText() == "-print"
            or self.lineEdit.displayText() == "-print "
        ):
            self.path_image = QtWidgets.QFileDialog.getSaveFileName()[0]
        ...
        if self.lineEdit.displayText() == "-restart":
            gcfi = self.system_terminal.text()
            if gcfi == "" or gcfi == " ":
                self.system_terminal.setText(
                    f"The script of host will be restarted, please wait.\n"
                )
            else:
                self.system_terminal.setText(
        ...
        if self.lineEdit.displayText().startswith("-fget"):
            ...
            if gcfi == "" or gcfi == " ":
                self.system_terminal.setText(
                    f"The file will be downloaded, please wait.\n"
                )
            else:
                self.system_terminal.setText(
        ...
        if self.lineEdit.displayText().startswith("-fput"):
            ...
            if gcfi == "" or gcfi == " ":
                self.system_terminal.setText(
                    f"The file will be uploaded, please wait.\n"
                )
            else:
                self.system_terminal.setText(
        ...
        if (
            ...
            with open(
                f"bin/request/transfer/execute/{self.hselected}", "w"
            ) as new_task:
                new_task.write("True")
                new_task.close()
                return
    ...
    def shell_control(self):
        ...
        if (
            command_output == ""
            or command_output == " "
            or command_output == "None"
            or command_output == "NoneNone"
            or command_output == b""
            or command_output == 'b""'
            or command_output == "b''"
        ):
            with open(
                f"bin/request/transfer/stdout/{self.hselected}", "w"
            ) as get_output:
                get_output.write("")
                get_output.close()
            return
        ...
        if (
            get_the_stdout == "None"
            or get_the_stdout == None
            or get_the_stdout == "NoneNone"
            or get_the_stdout == "None"
        ):
            return
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_title_bar_top.setText(
            QCoreApplication.translate("MainWindow", f"{self.name_host}", None)
        )
        ...
        self.label_top_info_1.setText(
            QCoreApplication.translate("MainWindow", "{HOST_IP}", None)
        )
        self.label_6.setText(QCoreApplication.translate("MainWindow", "HOME", None))
        self.label.setText(
            QCoreApplication.translate(
                "MainWindow", "Empyt Page - By: Wanderson M. Pimenta", None
            )
        )
