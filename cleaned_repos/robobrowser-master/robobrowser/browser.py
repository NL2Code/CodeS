...
class RoboBrowser(object):
    ...
    def __init__(
        ...
        if cache:
            ...
            raise ValueError(
                "Parameter `max_age` is provided, " "but caching is turned off"
            )
        elif max_count:
            raise ValueError(
                "Parameter `max_count` is provided, " "but caching is turned off"
            )
    ...
    def get_link(self, text=None, *args, **kwargs):
        ...
        """
        return helpers.find(self.parsed, _link_ptn, text=text, *args, **kwargs)
    ...
    def get_links(self, text=None, *args, **kwargs):
        ...
        """
        return helpers.find_all(self.parsed, _link_ptn, text=text, *args, **kwargs)
