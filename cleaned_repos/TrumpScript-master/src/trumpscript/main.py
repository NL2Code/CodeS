...
def main():
    parser = argparse.ArgumentParser(
        prog="TRUMP", description="Make programming great again"
    )
    parser.add_argument(
        "--Wall",
        action="store_true",
        help="If set, prevents running program from Mexican locales",
    )
    parser.add_argument(
        "--shut-up",
        action="store_true",
        help="If set, ignore all system warnings and run program. " "Overrides --Wall",
    )
