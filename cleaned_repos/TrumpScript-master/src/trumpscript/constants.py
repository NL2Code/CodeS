...
ERROR_CODES = {
    ...
    "unterminated_quote": [
        "And, believe me, if I win, if I become President, that will end.",
    ...
    "boycott": [
        "Mac? 'Boycott all Apple products  until such time as Apple "
    ...
    "ssl": [
        "An 'extremely credible source' has called my office and told me that one of this process's SSL "
