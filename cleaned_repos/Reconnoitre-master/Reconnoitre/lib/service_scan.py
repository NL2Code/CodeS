...
from Reconnoitre.lib.file_helper import (
    check_directory,
...
def nmap_scan(ip_address, output_directory, dns_server, quick, no_udp_service_scan):
    ...
    if dns_server:
        ...
        print(
            "[+] Starting detailed TCP%s nmap scans for %s"
...
def target_file(
    target_hosts, output_directory, dns_server, quiet, quick, no_udp_service_scan
):
