...
import yaml
from cachebrowser.pipes.sni import SNI_EMPTY, SNI_FRONT, SNI_ORIGINAL
...
class CacheBrowserSettings(object):
    ...
    def read_bootstrap_sources(self, args):
        ...
        for source in local_sources:
            self.bootstrap_sources.append({"type": "local", "path": source})
    ...
    def validate(self):
        ...
        if type(self.port) != int or not 0 < self.port < 65536:
            raise SettingsValidationError("invalid port number '{}'".format(self.port))
