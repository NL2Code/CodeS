...
def get_tag(blueprint: APIBlueprint, blueprint_name: str) -> t.Dict[str, t.Any]:
...
def get_operation_tags(blueprint: APIBlueprint, blueprint_name: str) -> t.List[str]:
...
def get_auth_name(auth: HTTPAuthType, auth_names: t.List[str]) -> str:
...
def get_security_and_security_schemes(
    auth_names: t.List[str], auth_schemes: t.List[HTTPAuthType]
