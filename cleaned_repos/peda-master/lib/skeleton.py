...
"""
        ...
        self.skeleton_local_argv = self.skeleton_local_argv.replace(
            "#TYPE#", "local argv"
        )
        self.skeleton_local_argv = self.skeleton_local_argv.replace(
            "#USAGE#", "target_program"
        )
...
if __name__ == "__main__":
    ...
    """
        ...
        self.skeleton_local_env = self.skeleton_local_env.replace(
            "#USAGE#", "target_program"
        )
...
if __name__ == "__main__":
    ...
    """
        ...
        self.skeleton_local_stdin = self.skeleton_local_stdin.replace(
            "#TYPE#", "local stdin"
        )
        self.skeleton_local_stdin = self.skeleton_local_stdin.replace(
            "#USAGE#", "target_program"
...
if __name__ == "__main__":
    ...
    """
        ...
        self.skeleton_remote_tcp = self.skeleton_remote_tcp.replace(
            "#TYPE#", "remote TCP"
        )
        self.skeleton_remote_tcp = self.skeleton_remote_tcp.replace(
            "#USAGE#", "host port"
