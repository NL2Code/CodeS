...
from go_questionary.constants import DEFAULT_QUESTION_PREFIX, DEFAULT_STYLE
from go_questionary.prompts.common import build_validator
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        completer: A prompt_toolkit :class:`prompt_toolkit.completion.Completion`
                   implementation. If not set, a go_questionary completer implementation
                   will be used.
