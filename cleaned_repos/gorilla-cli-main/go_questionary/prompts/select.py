...
from go_questionary import utils
from go_questionary.constants import (
    DEFAULT_QUESTION_PREFIX,
    DEFAULT_SELECTED_POINTER,
    DEFAULT_STYLE,
)
from go_questionary.prompts import common
from go_questionary.prompts.common import Choice, InquirerControl, Separator
...
def select(
    ...
    **kwargs: Any,
    ...
    the user to select multiple options, use :meth:`go_questionary.checkbox` instead).

    Example:
        >>> import go_questionary
        >>> go_questionary.select(
    ...
    def get_prompt_tokens():
        ...
        tokens = [("class:qmark", "🦍"), ("class:question", " {} ".format(message))]
        ...
        if ic.is_answered:
            ...
            if instruction:
                ...
                tokens.append(
                    ("class:instruction", "Welcome to Gorilla. Use arrows to select")
                )
