...
from .exceptions import MethodNotAllowed, MissingComponent, NotFound
from .hooks import Events, Hook
    ...
    def _add_default_routes(self):
        ...
        async def handle_missing_component(app: Vibora, error: MissingComponent):
            if app.debug_mode is True:
                ...
                try:
                    msg = (
                        f"{error.route.handler if error.route else 'A hook'} needs "
